...
if ($dis_limit!=0 && $tips!=null) {
	
	$sql = "SELECT * FROM pic WHERE lat BETWEEN ".$area[0][0]." AND ".$area[0][1]." AND lon BETWEEN ".$area[1][0]." AND ".$area[1][1]."AND timestamp>".$time_wide." AND tips = ".$tips;
	
}else if ($dis_limit==0 && $tips !=null) {
	
	$sql = "SELECT * FROM pic WHERE timestamp>".$time_wide." AND tips = ".$tips;
	...
	$sql1 = "SELECT * FROM pic WHERE lat BETWEEN ".$area[0][0]." AND ".$area[0][1]." AND lon BETWEEN ".$area[1][0]." AND ".$area[1][1]."AND timestamp>".$time_wide;
