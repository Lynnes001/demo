...
<body>
	...
	<div id="layout_right_content" class="layout_right_content">
		...
		<div class="mian_content">
			<div id="page_content">
				<h3>添加管理员</h3>
				<form action="doUserAction.php?act=editUser&id=<?php echo $id;?>" method="post">
					<table width="25%" border="1" cellpadding="5" cellspacing="0"
						...
						<tr>
							...
							<td><input type="text" name="age" placeholder="<?php echo $row['age']; ?>" /></td>
						</tr>
												<tr>
							<td align="right">性别</td>
							<td><input type="text" name="sex" placeholder="<?php echo $row['sex']; ?>" /> </td>
						</tr>
						<tr>
							<td align="right">真实姓名</td>
							<td><input type="text" name="truename" placeholder="<?php echo $row['truename']; ?>" /></td>
						</tr>
						<tr>
